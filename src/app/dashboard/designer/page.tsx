  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Track your projects, earnings, and client requests.</p>
      </div>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Badge variant="destructive">
                {designerProjects.filter(p => p.status === 'New Request').length}
            </Badge>
          </CardHeader>
          <CardContent>
              ...
              <TableBody>
                {designerProjects.map((project) => (
                  <TableRow key={project.id}>
                    ...
                    <TableCell className="text-right">{project.receivedDate}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
